...
export default function ConfigContextProvider(props: {
  ...
  const [usedRatings, setUsedRatings] =
    useState<usedRatings>(defaultUsedRatings);
  ...
  return (
    <ConfigContext.Provider
      value={{
        ...
        openedMenu: [openedMenu, setOpenedMenu],
        usedRatings: [usedRatings, setUsedRatings],
        highlightByRating: [highlightByRating, setHighlightByRating],
        showArrows: [showArrows, setShowArrows],
        arrowAfterMove: [arrowAfterMove, setArrowAfterMove],
        showLegalMoves: [showLegalMoves, setShowLegalMoves],
        animateMoves: [animateMoves, setAnimateMoves],
        boardSounds: [boardSounds, setBoardSounds],
        boardMenuSettingsRef: boardMenuSettingsRef,
      }}
    >
      {props.children}
    </ConfigContext.Provider>
