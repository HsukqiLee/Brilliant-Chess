...
export default function Attributions() {
  return (
    <div className="flex-grow h-full w-full max-w-[1400px] mx-auto">
      <header>
        <h1 className="text-4xl font-extrabold mx-auto mt-6 flex flex-row items-center gap-4 w-fit">
          <License draggable size={35} class="fill-foreground" />
          Attributions
        </h1>
      </header>
        ...
        <section className="bg-backgroundBox p-6 w-full rounded-borderRoundness">
          <h1 className="text-2xl font-bold flex flex-row items-center mx-auto mb-8 w-fit gap-2">
            ...
            >
              ...
              />
              <PieceSVG
                className="rotate-12 relative bottom-2 right-2"
                piece={KING}
                size={50}
                color={WHITE}
              />
          ...
          <ul className="text-lg">
            ...
            <li>
              ...
              <Link
                target="_blank"
                className="text-blue-600 hover:underline font-bold"
                href="https://github.com/nmrugg/stockfish.js/blob/master/license.txt"
              >
                GPL-3.0
              </Link>
            </li>
