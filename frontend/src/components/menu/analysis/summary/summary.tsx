...
export default function Summary(props: {
  ...
  const [accuracyPhases, setAccuracyPhases] = useState<accuracyPhases>({
    opening: { w: [], b: [] },
    middlegame: { w: [], b: [] },
    endgame: { w: [], b: [] },
  });
  ...
  return (
    <div ref={componentRef} className="flex flex-col gap-3 items-center">
      ...
      />
      <PlayersAccuracy
        reducedSummary={reducedSummary}
        setAccuracyPhases={setAccuracyPhases}
