        ...
        >
                  ...
                  {i === 2 ? (
                    <>
                      ...
                      <div
                        ...
                        style={{
                          backgroundColor: boardThemes[boardTheme].highlight,
                        }}
                      />
                    </>
                  ) : null}
                  {i === 1 && showLegalMoves ? (
                    <div className="absolute w-full h-full top-0 left-0 flex justify-center items-center pointer-events-auto">
                      <div className="bg-black opacity-[25%] w-[30%] h-[30%] rounded-full" />
                    </div>
                  ) : null}
                </div>
              );
          ...
          <div
            style={{
              ...
              display: showLegalMoves ? "" : "none",
            }}
            className="w-3 h-3 rounded-full absolute right-3"
          />
        </button>
        <button
          onClick={toggleAnimateMoves}
          type="button"
          className="flex flex-row gap-2 items-center hover:text-foregroundHighlighted hover:bg-black transition-colors w-full relative p-2"
        >
          <div className="grid grid-cols-2 w-fit">
                ...
                >
                  {i === 2 ? (
                    <>
                      <PieceSVG
                        style={{
                          transform: animateMovesMoved
                            ? "translateX(20px)"
                            : "",
                          transition: animateMoves ? "150ms" : "",
                          transitionTimingFunction: animateMoves
                            ? "linear"
                            : "",
                        }}
                        className="absolute z-10 top-0 left-0"
          ...
          <div
            style={{
              backgroundColor: "var(--foreground)",
              display: animateMoves ? "" : "none",
            }}
            className="w-3 h-3 rounded-full absolute right-3"
          />
        </button>
        <button
          onClick={toggleBoardSounds}
          type="button"
          className="flex flex-row gap-2 items-center hover:text-foregroundHighlighted hover:bg-black transition-colors w-full relative p-2"
        >
